...
function update() {
    ...
    if (cursors.left.isDown) { //  || Phaser.Input.Keyboard.KeyCodes.A
        player.setVelocityX(-190);
        player.anims.play('left', true);
    }
    else if (cursors.right.isDown) { //  || Phaser.Input.Keyboard.KeyCodes.A
        player.setVelocityX(190);
...
function collectStar(player, star) {
    ...
    if (stars.countActive(true) === 0 || dificultad=='hard') {
